//
//  VcamFix.m — 只修 4 处失效功能, 不加任何 UI, 不改源码
//
//  1. 视频不播放         → mediaserverd 侧门禁让 setEnabled: 从不触发
//  2. 点 + 面板消失      → VCamHidePatch hideBtn 落在 + 按钮上
//  3. 隐藏后三指不呼出   → VCamHidePatch 只找混淆类名 Jx6
//  4. 点"动作"后切不回控制 → 精简版 tabControlBtn 没 addTarget
//
//  不 swizzle VCamActionPatch 任何方法, 让它的动作 tab/页 和
//  FixActionPlayback 的"退出动作"按原流程注入
//
...
#pragma mark - 修复 2 & 3: VCamHidePatch
